...
class MainActivity : AppCompatActivity() {
    ...
    private val senderReceiverServiceConnection = object : ServiceConnection {
        override fun onServiceConnected(componentName: ComponentName, binder: IBinder) {
            ...
            senderFragment.onServiceConnected(senderReceiverService, ::showActiveIcon, ::hideActiveIcon)
            receiverFragment.onServiceConnected(senderReceiverService, ::showActiveIcon, ::hideActiveIcon)
        }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        TabLayoutMediator(tabs, pager) { tab, position ->
            ...
            tab.icon = resources.getDrawable(R.drawable.round_indicator)
            tab.icon?.alpha = 0
