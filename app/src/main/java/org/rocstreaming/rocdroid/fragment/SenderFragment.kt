...
class SenderFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.findViewById<TextView>(R.id.audio_source)?.text = audioSources[selectedAudioSourceIndex]
        ...
        val showAudioSourceDialog: ConstraintLayout = view.findViewById(R.id.audio_source_dialog_button)
